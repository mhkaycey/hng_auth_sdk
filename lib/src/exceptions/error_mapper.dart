...
class ErrorMapper {
  ...
  static AuthException mapGeneralException(dynamic e) {
    if (e is AuthException) return e;
    if (e is FirebaseAuthException) return mapFirebaseException(e);
    if (e is Exception) return UnknownAuthException(e.toString());
    return UnknownAuthException(
      e?.toString() ?? 'An unexpected error occurred',
    );
  }
}
